    ...
    <div>
      ...
      <div className='heroBg h-screen '>
        ...
        <div className='text-center '>
          ...
          <div>
            <a href="/availablecars" className='bg-red-700 px-10 py-2 md:mt-32 sm:mt-20 mt-10 text-white font-bold inline-block no-underline
      ...
      <div className='aboutBg '>
        ...
        <div className='text-center pb-12 '>
          <a href="/availablecars" className='bg-white inline-block px-10 py-2 mt-24 text-blue-700 font-bold no-underline '> View Available Cars </a>
        </div>
      </div>
